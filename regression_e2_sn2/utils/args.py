...
def parse_args(cross_val=False):
    ...
    parser.add_argument('-d', '--depth', default=4, type=int,
                        help='Number of layers in the WLN')
    ...
    parser.add_argument('--data_path', default='datasets/e2_sn2_regression.csv', type=str,
    ...
    parser.add_argument('--selec_batch_size', default=10, type=int,
                        help='Batch size while training the model')
    parser.add_argument('--selec_epochs', default=50, type=int,
                        help='Number of epochs while training the model')
    ...
    parser.add_argument('--select_descriptors', nargs='+',
                        ...
                        help='(Optional) Selection of descriptors to feed to the ml_QM_GNN model '
                             '(either the default selection, "partial_charge nmr", "fukui_elec fukui_neu" '
                             'or "only_bonds") ')
    ...
    if args.model == 'ml_QM_GNN':
        ...
        raise NotImplementedError('Model not implemented, only allow ml_QM_GNN and GNN')
